...
{{-- heading content --}}
@section('heading','Add New Lcoation')
{{-- Main content--}}
              ...
              {{-- end show error --}}
				<form  method="POST" action="/location/store">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="contact_name" placeholder="Area Name" name="area_name">
					</div>
			      <div class="form-group">
			        <label for="number">Area Code</label>
			        <input type="text" class="form-control" id="number" placeholder="Area Code" name="area_code">
			      </div>
            <div class="form-group">
