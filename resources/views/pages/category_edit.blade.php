        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              @endif
              {{-- end show error --}}
				<form  method="POST" action="/category/update/{{$datas->id}}">
					@csrf
					<div class="form-group">
						<label for="contact_name">Category Name</label>
						<input type="text" class="form-control" id="contact_name" placeholder="Category Name" name="category_name" value="{{$datas->category_name}}">
					</div>
			      <div class="form-group">
			        <label for="number">Category Code</label>
			        <input type="text" class="form-control" id="number" placeholder="Category code" name="category_code" value="{{$datas->category_code}}">
			      </div>
            <div class="form-group">
